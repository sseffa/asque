...
<div class="blog-header">
    <div class="col-md-9">
        ...
        <div class="pull-right "><i style="color: #c0392b !important;"></i>
            {{ link_to_route("answered.post", "Cevaplanmış Sorular", array(), array("class"=>"btn btn-primary btn-xs")) }}
            {{ link_to_route("unanswered.post", "Cevaplanmamış Sorular", array(), array("class"=>"btn btn-primary btn-xs")) }}
        </div>
    </div>
</div>
<br>
