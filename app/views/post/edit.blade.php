...
<div style="margin-bottom: 25px;" class="container">
    ...
    <div class="row">
        ...
        <div class="control-group {{ $errors->has('type') ? 'error' : '' }}">
            ...
            <div class="controls">
                {{ Form::radio('type', 1, ($post->post_type_id == 1) ? true : false) }}<span>  Soru</span><br>
                {{ Form::radio('type', 3, ($post->post_type_id == 3) ? true : false) }} <span>  Not</span>
        ...
        <div class="control-group {{ $errors->has('title') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {{ Form::text('title', $post->title, array('class'=>'form-control', 'id' => 'title', 'placeholder'=>'Başlık', 'value'=>Input::old('title'))) }}
        ...
        <div class="control-group {{ $errors->has('body') ? 'has-error' : '' }}">
            ...
            <div class="controls">
                {{ Form::textarea('body', $post->body, array('class'=>'summernote', 'id' => 'body', 'placeholder'=>'Soru', 'value'=>Input::old('body'))) }}
